## 이번 포스팅에서는 Next.js 13으로 Github Blog를 만드는 방법에 대해 알아보겠습니다.

깃허브 블로그 만들기 시리즈는 총 3부작으로 구성되며,<br>
1부에서는 Next.js 13 설치, 깃허브 저장소 생성과 설정에 대해 다룹니다.<br><br>
...
자세한 내용은 [Next.js 13 공식문서](https://nextjs.org/docs)를 읽으시길 바랍니다.
...
|1부 목차|설명|
|---|---|
|[Next.js 13 install](#nextjs-13-install)|Next.js 13 설치|
...
[Next.js 13 설치하기](https://nextjs.org/docs/getting-started/installation)<br>
<br>
...
아래의 프롬프트는 Next.js 13의 설정에 관한 것입니다. <br>
원하시는 설정을 하시고 난 후, 엔터를 끝까지 입력하시면 Next.js 13 프로젝트가 만들어집니다.
...
이후의 동작은 gif와 같이 Next.js configure를 클릭한 후, github action workflow를 생성합니다.<br>

![git8](https://github.com/wookiya1364/wookiya1364.github.io/assets/16011536/06134194-41b8-48ec-b596-1da5acc8c99c)


이제부터는 github main 브랜치에 커밋할 때마다, github action에서 build됩니다.<br>
github action workflow에서 브랜치를 지정해주지 않았기 때문입니다.<br>
만약 Default branch를 main에서 다른걸로 변경하셨다면 커밋할 때마다 적용되지 않으므로,<br>
